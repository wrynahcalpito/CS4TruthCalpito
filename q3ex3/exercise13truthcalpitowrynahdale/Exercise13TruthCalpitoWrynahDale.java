package exercise13truthcalpitowrynahdale;

import static exercise13truthcalpitowrynahdale.Subject.subjectList;
...
public class Exercise13TruthCalpitoWrynahDale extends Application {
    ...
    private Pane ContentDisplay() {
        ...
        Image subjectImage = new Image(Exercise13TruthCalpitoWrynahDale.class.getResourceAsStream(displayedSubject.getImgFileName()));
    ...
    private Pane HeaderDisplay() {
        ...
        Image pisayLogo = new Image(Exercise13TruthCalpitoWrynahDale.class.getResourceAsStream("pisay.png"));
        ...
        searchBtn.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                if(Subject.searchSubject(searchInput)== null) {
                    search.getChildren().add(new Text("Search invalid."));
                }
                else if(Subject.searchSubject(searchInput)!= null) {
                    displayedSubject = Subject.searchSubject(searchInput);
                    main.setCenter(ContentDisplay());     
                    //search.getChildren().add(new Text(displayedSubject.getName()));
                }
            }
        });
